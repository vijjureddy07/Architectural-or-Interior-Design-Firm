...
const ServiceDetailsPage = (() => {
  ...
  const serviceData = {
    'architectural-design': {
      ...
      gallery: [
        { src: '../assets/images/pages/case-studies/cao-leo-lvpo7M0WXKM-unsplash.jpg', alt: 'Architectural cabin exterior set within a forested landscape.' },
        { src: '../assets/images/pages/portfolio/serjan-midili-8SuNIFnfKZY-unsplash.jpg', alt: 'Beachside residence exterior with strong glazing and clean architectural lines.' },
    ...
    visualization: {
      ...
      heroImage: '../assets/images/pages/dashboard-user/renderings/render-01.jpg',
      heroAlt: 'Photoreal interior rendering showing mood, material contrast, and spatial depth.',
      spotlightImage: '../assets/images/pages/services/jakub-pabis-sbzTCm-5dtg-unsplash.jpg',
      spotlightAlt: 'Large-screen visualization review showing render precision and material balance.',
      spotlightLabel: 'Studio Focus',
      ...
      gallery: [
        { src: '../assets/images/pages/dashboard-user/renderings/render-03.jpg', alt: 'Kitchen visualization with realistic material contrast and daylight calibration.' },
        { src: '../assets/images/pages/dashboard-user/renderings/render-09.jpg', alt: 'Dining room rendering prepared for design approval and presentation.' },
        { src: '../assets/images/pages/dashboard-user/renderings/render-10.jpg', alt: 'Terrace visualization with cinematic evening atmosphere and lighting control.' }
      ],
    ...
    'project-delivery': {
      ...
      heroImage: '../assets/images/pages/case-studies/peter-thomas-qXbueROjM9I-unsplash.jpg',
      heroAlt: 'Completed executive workspace showing coordinated detailing and material alignment.',
      spotlightImage: '../assets/images/pages/services/alexander-van-steenberge-uBQQwpYFTfI-unsplash.jpg',
      spotlightAlt: 'Drawing package and finish boards organized for delivery coordination.',
      spotlightLabel: 'Studio Focus',
      ...
      gallery: [
        { src: '../assets/images/pages/portfolio/serjan-midili-8SuNIFnfKZY-unsplash.jpg', alt: 'Completed penthouse living area with resolved joinery and finish continuity.' },
        { src: '../assets/images/pages/services/kam-idris-qsrm2_RtFZ4-unsplash.jpg', alt: 'Material selections and coordination notes prepared for installation sequencing.' },
        { src: '../assets/images/pages/case-studies/martin-katler-qM4xm0PdhFs-unsplash.jpg', alt: 'Hospitality interior delivered with aligned lighting, furniture, and detailing.' }
      ],
    ...
    procurement: {
      ...
      heroImage: '../assets/images/pages/services/kam-idris-qsrm2_RtFZ4-unsplash.jpg',
      heroAlt: 'Curated material samples and finish selections arranged for procurement approval.',
      spotlightImage: '../assets/images/pages/services/alexander-van-steenberge-uBQQwpYFTfI-unsplash.jpg',
      spotlightAlt: 'Selection schedules and sample boards organized for supplier coordination.',
      spotlightLabel: 'Studio Focus',
      ...
      gallery: [
        { src: '../assets/images/pages/home-2/ela-de-pure-wK2nvKuHv18-unsplash.jpg', alt: 'Premium bath finishes selected for a coordinated procurement package.' },
        { src: '../assets/images/pages/portfolio/bas-van-den-eijkhof-s6W9cOkOFHc-unsplash.jpg', alt: 'Interior furnishings and finishes curated to support a premium residential fit-out.' },
        { src: '../assets/images/pages/home-1/t-selin-erkan-bpcWrkKKtZc-unsplash.jpg', alt: 'Architectural entry materials and fixtures prepared for final procurement approval.' }
      ],
